...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validateForm()) {
      setStatus("Veuillez remplir correctement tous les champs requis.");
      return;
    }

    const form = new FormData();
    form.append("access_key", "1e7ecaab-8736-4491-bc03-6e185880a2fb");
    form.append("name", formData.name);
    form.append("email", formData.email);
    form.append("subject", formData.subject || "Nouveau message de contact");
    ...
    try {
      ...
      if (response.ok) {
        ...
        setStatus(result.message || "Une erreur est survenue lors de l’envoi.");
      }
    } catch (error) {
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-300 text-lg">
                  Une question ? Une idée de projet ? N'hésitez pas à m’écrire, je vous répondrai avec plaisir !
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">dylanqin4@gmail.com</p>
                  </div>
                </div>
